...
function submitForm() {
  ...
  const juiceForm = document.querySelector("#juice-form");

  if (juiceForm.checkValidity()) {
    ...
    const someInstructionsHeader = document.createElement("p");
    const someInstructions = document.createElement("p");
    someInstructionsHeader.textContent = `Instructions:`;
    specialInstructions.textContent = `${document.querySelector("#some-instructions").value}`;
    responseSection.appendChild(someInstructionsHeader);
    responseSection.appendChild(someInstructions);
    ...
    document.querySelector("#some-instructions").value = "";

    
    responseSection.className = "visible";

  
    document.querySelector("#submitbtn").value = "Sumbit Another Drink";
